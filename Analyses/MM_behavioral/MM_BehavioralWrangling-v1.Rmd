...
rawDf_1 <- data.table::fread("~/GitLab/SecondYearProject/MemoryMaps/Data/raw/behavioral_output/MM-S1_34.csv")
...
valid_ids <- c(2,4,5,8,17,19,22,23,24,26,31,34,41,42,43,44,45,46,48,50,59,61,108,
               75,39,33,82,76,83,88,84,89,79,80)
...
rawDf_2 <- data.table::fread("MMS2_34.csv")
...
# write.csv(fullLong,"~/Downloads/fullLong.csv", row.names = FALSE)
# write.csv(fullShort,"~/Downloads/fullShort.csv", row.names = FALSE)
```
