...
fullLong <- read.csv("~/GitLab/SecondYearProject/MemoryMaps/Data/processed/fullLong40.csv")
fullLong <- fullLong[-1, ]

# Import fullShort - doesn't include memories for each subject
fullShort <- read.csv("~/GitLab/SecondYearProject/MemoryMaps/Data/processed/fullShort40.csv")
...
write.csv(fullData,"~/GitLab/SecondYearProject/MemoryMaps/Data/processed/fullData40.csv")
...
write.csv(cent,"centralityDf_40.csv") # Write file to csv for later onset files
```
